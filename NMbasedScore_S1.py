...
import NMbasedScore_S2
import ScorePanel
import re

from Ui.NMbasedScore_S1_Ui import Ui_Dialog

class NMbasedScore_S1(QtWidgets.QDialog,Ui_Dialog):
    _stype1 = ""
    _stype2 = ""
    _isSubtype = False
    _subtypeName = ""
    ...
    def __init__(self, cname):
        super(NMbasedScore_S1, self).__init__()
        self.setupUi(self)
        ...
        self.commandLinkButton.clicked.connect(lambda :self.toNMbasedScore_S2(cname,self._stype, str(self._percent)))
    ...
    def toNMbasedScore_S2(self,cname,stype, percent):
        ...
        if self.comboBox_2.isVisible()==True and self.comboBox_2.currentText()=="default value":
            ...
            if self.lineEdit_3.text()=="":
                ...
                self.hide()
                self.s = NMbasedScore_S2.NMbasedScore_S2(cname,stype, percent)
                self.s.show()
