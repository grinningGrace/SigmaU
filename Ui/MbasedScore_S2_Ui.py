...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(50, 120, 231, 41))
        ...
        self.commandLinkButton_3.setGeometry(QtCore.QRect(330, 590, 151, 41))
        self.commandLinkButton_3.setObjectName("commandLinkButton_3")
        self.label_courseName = QtWidgets.QLabel(Dialog)
        self.label_courseName.setGeometry(QtCore.QRect(50, 70, 111, 21))
        self.label_courseName.setObjectName("label_courseName")
        self.label_scoreFileType = QtWidgets.QLabel(Dialog)
        self.label_scoreFileType.setGeometry(QtCore.QRect(50, 90, 151, 31))
        self.label_scoreFileType.setObjectName("label_scoreFileType")
        self.pushButton_3 = QtWidgets.QPushButton(Dialog)
        self.pushButton_3.setGeometry(QtCore.QRect(40, 20, 113, 32))
